...
DONATION_TEXT = (  # тот же текст, дословно, что и P.S. в PhotoArchive_ot_avtora.md -- при
    ...
    # 2026-07-17: реальный номер карты временно убран -- карта была скомпрометирована и
    # заблокирована, реквизиты будут добавлены заново перед распространением программы за
    # пределами тестирования (не влияет на сам процесс тестирования).
    ...
    "такая возможность появится здесь позже: реквизиты сейчас обновляются (прежняя карта\n"
    "была скомпрометирована и заблокирована)."
)
